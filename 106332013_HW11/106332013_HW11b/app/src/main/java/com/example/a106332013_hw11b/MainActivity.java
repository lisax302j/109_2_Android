...
package com.example.a106332013_hw11b;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_picshow = (Button) findViewById(R.id.picShow);
        button_picshow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showpicNotification();
            }
    ...
    private void showpicNotification() {
        ...
        NotificationCompat.Builder mBuilder =  new NotificationCompat.Builder(MainActivity.this)
                ...
                .addAction(R.drawable.ic_baseline_share_24, "Share", pendingIntent)
                .setStyle(bpStyle);
