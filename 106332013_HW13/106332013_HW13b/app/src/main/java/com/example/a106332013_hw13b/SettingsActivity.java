...
package com.example.a106332013_hw13b;
...
import com.example.a106332013_hw13b.AppCompatPreferenceActivity;
import com.example.a106332013_hw13b.R;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment
        ...
        public static final String PREF_EXP_LIMIT ="example_choose";
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("example_choice"));

            preferenceChangeListener=new SharedPreferences.OnSharedPreferenceChangeListener ( ) {
                @Override
                public void onSharedPreferenceChanged(SharedPreferences sharedPreferences , String key) {
                    if(key.equals ( (PREF_EXP_LIMIT) ))
                    {
                        Preference expPref = findPreference ( key );
                        expPref.setSummary ( sharedPreferences.getString ( key,""+"messages per conversation" ) );
                    }
                }
            };
