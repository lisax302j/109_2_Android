...
//        }
//        else{
//            mProgressBar.getIndeterminateDrawable ().setColorFilter ( ContextCompat.getColor(this, android.R.color.holo_green_light),new PorterDuff () );
//        }
    ...
    public void startTask(View view) {
        ...
        */
        SimpleAsyncTask mytask=new SimpleAsyncTask ( this,mTextView );
        mytask.setProgressBar(mProgressBar);
        mytask.execute (  );
    }
